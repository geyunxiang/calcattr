...
% This function basically calculates attributes between brain regions
    ...
    for iperson = 1:size(inpeople, 1)
        ...
        xz_inter_region_person(infolder, curperson, 'strong', 0.5, templateLong);
        fprintf('%s finished.\n', curperson);
    end
    fprintf('inter region finished.\n');
end

function xz_inter_region_person(infolder, curperson, weakstrong, netthreshold, templateLong)
